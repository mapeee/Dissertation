...
for Bezug in Resolution:
    ...
    for groups in f:
        if "PRZ_MIV" not in groups:continue
        gr = f[groups]
        r = 1
        print groups
        for i in gr:
            ...
            if "_MIV" in i: ##tFuss
                ...
                ##--export--##
                if export == 1: 
                    if "E_Hausarzt_MIV_100" == i and export_bezug == Bezug[0]: zbezug.to_excel("U:"+f[2]+export_bezug.split("_")[1]+"_VarK_"+zent+met+"_MIV.xls")
            ...
            if "_MIV" in i: ##tRad   
                w = "tAkt"
                if meter == 1: w = "Meter"
                a100["tAkt"] = a100["tAkt"]+5
                data_v["meanBezug"] = data_v["meanBezug"]+5
                z100 = a100[a100["tAkt"]<=60]
                z100 = z100.drop(['Ziel_ID'],axis=1)
#                if meter == 0:
...
#                    data_v = data_v.rename(columns={w: "meanBezug"})  
                ...
                ##--export--##
                if export == 1: 
                    if "E_Hausarzt_MIV_100" == i and export_bezug == Bezug[0]: zbezug.to_excel("U:"+f[3]+export_bezug.split("_")[1]+"_VarK_"+zent+met+"_MIV.xls")
