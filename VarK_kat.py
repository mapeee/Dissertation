    ...
    for groups in f:
        ...
        for i in gr:
            ...
            if "_OEV" in i:
                ...
                data_v = data_v[data_v["Reisezeit"]<=60]
                ...
                if runden == 1:
                    z100[w][z100[w].between(0, 10)]=10
                    z100[w][z100[w].between(10.001, 20)]=20
                    z100[w][z100[w].between(20.001, 30)]=30
                    z100[w][z100[w].between(30.001, 40)]=40
                    z100[w][z100[w].between(40.001, 50)]=50
                    z100[w][z100[w].between(50.001, 60)]=60  

                    data_v["meanBezug"][data_v["meanBezug"].between(0, 10)]=10
                    data_v["meanBezug"][data_v["meanBezug"].between(10.001, 20)]=20
                    data_v["meanBezug"][data_v["meanBezug"].between(20.001, 30)]=30
                    data_v["meanBezug"][data_v["meanBezug"].between(30.001, 40)]=40
                    data_v["meanBezug"][data_v["meanBezug"].between(40.001, 50)]=50
                    data_v["meanBezug"][data_v["meanBezug"].between(50.001, 60)]=60
                    data_v["meanBezug"][data_v["meanBezug"].between(60.001, 70)]=70
                    data_v["meanBezug"][data_v["meanBezug"].between(70.001, 80)]=80
                    data_v["meanBezug"][data_v["meanBezug"].between(80.001, 90)]=90 
                ...
                ##--export--##
                if export == 1: 
                    if "E_Hausarzt_OEV_100" == i and export_bezug == Bezug[0]: zbezug.to_excel("U:"+f[2]+export_bezug.split("_")[1]+"_VarK_"+zent+"_kat.xls")
            ...
            if "_MIV" in i:
                ...
                ##--export--##
                if export == 1: 
                    if "E_Hausarzt_MIV_100" == i and export_bezug == Bezug[0]:zbezug.to_excel("U:"+f[3]+export_bezug.split("_")[1]+"_VarK_"+zent+met+"_kat.xls")
            ...
            if "_NMIV" in i: ##tFuss
                ...
                ##--export--##
                if export == 1: 
                    if "E_Hausarzt_NMIV_100" == i and export_bezug == Bezug[0]: zbezug.to_excel("U:"+f[4]+export_bezug.split("_")[1]+"_VarK_"+zent+met+"_kat.xls")
            ...
            if "_NMIV" in i: ##tRad   
                ...
                ##--export--##
                if export == 1: 
                    if "E_Hausarzt_NMIV_100" == i and export_bezug == Bezug[0]: zbezug.to_excel("U:"+f[5]+export_bezug.split("_")[1]+"_VarK_"+zent+met+"_kat.xls")
